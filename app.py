...
write a MASSIVE, COMPREHENSIVE IEEE-format LaTeX thesis/research paper on the topic: "{topic}"

Your task is to yield an extremely detailed manuscript totaling approximately 10,000 words. 
You must adhere to the following STRICT minimum length requirements per section:
- Introduction: ~1,500 words (Deeply explore the background, problem statement, and motivation)
- Related Work: ~1,000 words (Exhaustively review the provided literature references)
- Methodology: ~2,000 words (Detail the mathematical architecture, datasets, pre-processing, and training regimes)
- Experimental Results: ~2,500 words (Extensively document the metrics, ablations, baseline comparisons, and edge cases)
- Discussion & Conclusion: Remainder (Deeply analyze the implications and limitations)
